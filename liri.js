/*
1. Get Spotify Api Keys Client ID af2c6c6526734faca44623cac182f1a0, 
Client Secret 746b2782f2cd48d397662cb1c945dbd7

    
URL:https://accounts.spotify.com/authorize?client_id=af2c6c6526734faca44623cac182f1a0&response_type=code&redirect_url=https%3A%2F%2Fapi-university.com%2F%20 

2. Look at and implement .env
3. IF you have time, swap dateformat for momentjs
    ...
    request(queryUrl, function (err, response, body) {
        ...
        if (!err && response.statusCode === 200) {
            ...
            for (i = 0; i < concertInfo.length; i++) {
                ...
                outputData("Date: " + concertInfo[i].datetime)
            }
        }
    })
}
